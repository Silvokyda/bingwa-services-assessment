        ...
        <div class="modal-body">
          <form @submit.prevent="saveProject">
            <div class="form-group">
              ...
              <input type="text" v-model="currentProject.name" required disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" v-model="currentProject.progress" min="0" max="100" required>
            </div>
            <div class="form-group">
              <label>Priority</label>
              <select v-model="currentProject.priority" required>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="primary-btn">Update Project</button>
            </div>
          </form>
        </div>
      </div>
